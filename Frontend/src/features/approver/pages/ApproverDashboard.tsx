    ...
    const buildApproverExportData = useCallback((rows: ApproverItem[]) => {
        return rows.map((row) => {
            ...
            return {
                ...
                'M_COUNT':                          (row as any).fCount || '',
                'M_CONSTRUCTION':                   (row as any).fConstruction || '',
                'M_LYCRA':                          row.lycra || '',
                'M_FINISH':                         row.finish || '',
                'M_GSM':                            row.gsm || '',
                'M_OUNZ':                           (row as any).fOunce || '',
                'M_WIDTH':                          (row as any).fWidth || '',
                'M_FAB_DIV':                        (row as any).fabDiv || '',
                'SHADE':                            row.shade || '',
                'WEIGHT':                           row.weight || '',
                // BODY group
                ...
                'M_EXTRA_POCKET':                   (row as any).extraPocket || '',
                'M_FIT':                            row.fit || '',
                'M_LENGTH':                         row.length || '',
                'FO BTN STYLE':                     row.frontOpenStyle || '',
                // VA ACC group
                'M_DC_STYLE':                       row.drawcord || '',
                'M_DC_SHAPE':                       (row as any).dcShape || '',
