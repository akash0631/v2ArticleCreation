...
export const SCHEMA_KEY_TO_EXCEL_ATTR: Record<string, string> = {
  ...
  patches:           'M_PATCHES',
  patch_type:        'M_PATCH_TYPE',
  patches_type:      'M_PATCH_TYPE',
  patch_style:       'M_PATCHES',
  embroidery:        'M_EMB_TYPE',
  embroidery_type:   'M_EMBROIDERY',
  emb_placement:     'M_EMB_PLACEMENT',
  button:            'M_BTN_MAIN_MVGR',
  btn_colour:        'M_BTN_CLR',
  zipper:            'M_ZIP',
  zip_colour:        'M_ZIP_COL',
  wash:              'M_WASH',
  drawcord:          'M_DC_SUB_STYLE',
  dc_shape:          'M_DC_SHAPE',
  father_belt:       'M_BLT_MAIN_STYLE',
  htrf_type:         'M_HTRF_TYPE',
  htrf_style:        'M_HTRF_STYLE',
  shade:             'SHADE',
  weight:            'WEIGHT',
  child_belt:        'M_SUB_STYLE_BLT',
