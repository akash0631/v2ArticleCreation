...
const FIELD_MANDATORY_KEYS: Record<string, readonly string[]> = {
  fabDiv:         ['M_FAB_DIV'],
  yarn1:          ['M_YARN'],
  fabricMainMvgr: ['FAB-MAIN-MVGR-2', 'FAB_MAIN_MVGR-2'],
  weave:          ['WEAVE-01', 'WEAVE 01', 'WEAVE_01'],
  mFab2:          ['WEAVE 02', 'WEAVE-02', 'WEAVE_02'],
  lycra:          ['M_LYCRA'],
  ...
  length:         ['M_LENGTH'],
  fit:            ['M_FIT'],
  pattern:        ['BODY STYLE', 'M_PATTERN', 'BODY_STYLE'],
